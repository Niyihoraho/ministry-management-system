...
import SmallGroupForm from "./SmallGroupForm";
import SmallGroupTable from "./SmallGroupTable";

export default function SmallGroupDirectoryPage() {
    ...
    >
      ...
      {view === 'add' ? (
        <div className="mx-auto w-full max-w-xl">
          <SmallGroupForm onSuccess={() => { setView('view'); setRefreshKey(prev => prev + 1); }} />
        </div>
      ) : (
