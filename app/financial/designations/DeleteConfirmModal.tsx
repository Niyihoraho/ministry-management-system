    ...
    <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4 shadow-lg">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Delete Designation</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex items-start space-x-3 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              You are about to delete the designation <strong>"{designationName}"</strong>. 
              This action cannot be undone.
            </p>
            <p className="text-sm text-red-600 dark:text-red-400 mt-2">
              Note: This designation cannot be deleted if it has existing contributions.
            </p>
          </div>
        </div>
